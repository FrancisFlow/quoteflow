...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[]= [
    ...
    new Quote("Some people look for a beautiful place. Others make a beautiful place", "~anonymous", "Kennedy Kamiro", 8, 0),
    new Quote("Keep your face to the sunshine and you cannot see a shadow", "Hellen Keller", "Walter Whitman", 9, 0),
    ...
    new Quote("No matter how the wind howls, the mountain cannot bow to it", "Mula", "Disney Okumu", 3, 0)
  ];
